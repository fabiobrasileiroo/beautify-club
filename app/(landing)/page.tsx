  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2 space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/plans">
                  <Button variant="accent" size="lg" className="w-full sm:w-auto text-white font-medium">
                    Ver planos
        ...
        <section className="py-20 bg-white dark:bg-gray-900">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-10">
              <div className="flex flex-col items-center text-center p-6 bg-secondary rounded-lg shadow-md">
        ...
        <section className="py-20 bg-primary">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 text-foreground">Nossos planos</h2>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                <div className="p-8 bg-secondary">
                  ...
                  <div className="mt-4 flex items-baseline">
                    ...
                    <span className="ml-1 text-xl text-foreground">/mês</span>
                  </div>
                </div>
                <div className="p-8">
                  ...
                  <Button variant="accent" className="w-full mt-8 text-white font-medium">
                    Assinar agora
                  </Button>
                </div>
              </div>
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden transform scale-105 z-10">
                <div className="p-8 bg-accent">
                  <h3 className="text-2xl font-bold text-white">Padrão</h3>
                  <div className="mt-4 flex items-baseline">
                    <span className="text-5xl font-extrabold text-white">R$199</span>
                    <span className="ml-1 text-xl text-white opacity-80">/mês</span>
                  </div>
                </div>
                <div className="p-8">
                  <ul className="space-y-4">
              ...
              <div className="bg-secondary p-8 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-foreground">Cliente há 6 meses</p>
                  </div>
                </div>
              ...
              <div className="bg-secondary p-8 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-foreground">Cliente há 3 meses</p>
                  </div>
                </div>
                <p className="text-foreground">
              ...
              <div className="bg-secondary p-8 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-foreground">Cliente há 1 ano</p>
                  </div>
                </div>
                <p className="text-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/plans" className="text-foreground hover:text-accent">
                    Planos
                  </Link>
                </li>
                <li>
                  <Link href="/salons" className="text-foreground hover:text-accent">
                    Salões
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/partner/register" className="text-foreground hover:text-accent">
                    Torne-se um parceiro
                  </Link>
                </li>
                <li>
                  <Link href="/partner/login" className="text-foreground hover:text-accent">
                    Login de parceiros
                  </Link>
                </li>
                <li>
                  <Link href="/partner/resources" className="text-foreground hover:text-accent">
                    Recursos
                  </Link>
                </li>
              </ul>
